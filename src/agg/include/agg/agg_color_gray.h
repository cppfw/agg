...
namespace agg
{
    ...
    struct gray16
    {
        ...
        {
            // Calculate grayscale value as per ITU-R BT.709.
            return value_type(uround((0.2126 * c.r + 0.7152 * c.g + 0.0722 * c.b) * int(base_mask)));
        }
        ...
        static AGG_INLINE value_type from_double(double a)
        {
            return value_type(uround(a * int(base_mask)));
        }
        ...
        AGG_INLINE void add(const self_type& c, unsigned cover)
        {
            ...
            {
                cv = v + mult_cover(c.v, cover_type(cover));
    ...
    struct gray32
    {
        ...
        operator rgba8() const 
        {
            rgba8::value_type y = rgba8::value_type(uround(v * 255.0));
		...
		operator rgba16() const
		{
			rgba16::value_type y = rgba16::value_type(uround(v * 65535.0));
        ...
        static AGG_INLINE value_type mult_cover(value_type a, cover_type b) 
        {
            return value_type(a * b / int(cover_mask));
        }
